...
function getAllProductVariants()
{
    ...
    {
        item: "14054035",
        value: "訂製蛋糕 Custom Cake (價格待定 Price TBD)",
        page: "custom"},
    {
        item: "14890875",
        value: "訂製杯子蛋糕 Custom Cupcake (價格待定 Price TBD)",
        page: "custom"},
    {
        item: "14856231",
        value: "訂製蛋糕棒棒糖 Custom Cake Pop (價格待定 Price TBD)",
        page: "custom"},
    {
        item: "13276274-2H6L",
        value: "6\" 單層圖片蛋糕 Single-Layer Picture Cake NT$1200",
        page: "picture"},
    {
        item: "13276274-4H6L",
        value: "6\" 圖片蛋糕 Picture Cake NT$1900",
        page: "picture"},
    {
        item: "13276274-4H8L",
        value: "8\" 圖片蛋糕 Picture Cake NT$2800",
        page: "picture"},
    {
        item: "14803563-2H8L8W",
        value: "8x8\" 單層圖片蛋糕 Single-Layer Picture Cake NT$2600",
        page: "picture"},
    {
        item: "14803563-4H8L8W",
        value: "8x8\" 圖片蛋糕 Picture Cake NT$4200",
        page: "picture"},
    {
        item: "14803563-2H11L7W",
        value: "11x7\" 單層圖片蛋糕 Single-Layer Picture Cake NT$2800",
        page: "picture"},
    {
        item: "14803563-4H11L7W",
        value: "11x7\" 圖片蛋糕 Picture Cake NT$4900",
        page: "picture"},
    {
        item: "13383153-2H6L",
        value: "6\" 單層經典款蛋糕 Single-Layer Classic Cake NT$800",
        page: "classic"},
    {
        item: "13383153-4H6L",
        value: "6\" 經典款蛋糕 Classic Cake NT$1200",
        page: "classic"},
    {
        item: "13383153-4H8L",
        value: "8\" 經典款蛋糕 Classic Cake NT$2000",
        page: "classic"},
    {
        item: "13383559-MINI",
        value: "一打經典款迷你杯子蛋糕 One Dozen Classic Mini-Cupcakes NT$500",
        page: "cupcakes"},
    {
        item: "13383559",
        value: "經典款杯子蛋糕 Classic Cupcake NT$80",
        page: "cupcakes"},
    {
        item: "13369293",
        value: "一打經典款蛋糕棒棒糖 One Dozen Classic Cake Pops NT$960",
        page: "cakePops"},
    {
        item: "13385422-4H6L",
        value: "6\" 經典款棒的蛋糕 Classic Bundt Cake NT$600",
        page: "bundt"},
    {
        item: "13385422-4H9L",
        value: "9\" 經典款棒的蛋糕 Classic Bundt Cake NT$1000",
        page: "bundt"},
    {
        item: "13433214-CAKE",
        value: "蛋糕架的租金 Cake Stand Rental NT$300 (不包括押金 security deposit required)",
        page: "rentals"},
    {
        item: "13433214-CUPCAKE",
        value: "杯子蛋糕架的租金 Cupcake Stand Rental NT$300 (不包括押金 security deposit required)",
        page: "rentals"},
    {
        item: "13433214-CAKEPOP",
        value: "蛋糕棒棒糖架的租金 Cake Pop Stand Rental NT$300 (不包括押金 security deposit required)",
        page: "rentals"}
    ]
    return result;
}
...
function getFormFieldsMetaData()
{
    var result = {
        addToCart: {
            type: "button",
            title: "加入購物車 Add to Cart",
            placeholder: "加入購物車 Add to Cart"
        },
        alley: {
            type: "number",
            title: "弄 Alley",
        ...
        budget: {
            type: "number",
            title: "預算 Budget (NT$)",
            tip: " Approximately how much do you wish to spend?",
            placeholder: "例如：3000"
        },
        city: {
            type: "text",
            title: "縣市/鄉鎮【市】 City",
            placeholder: "例如：台北 Taipei",
            isRequired: true
        },
        comment: {
            type: "text",
        ...
        deliveryAddress: {
            type: "text",
            title: "送貨地址 Delivery Address",
            placeholder: "※ 付附加費用 Additional Fee Applies"
        },
        district: {
            type: "text",
            title: "區域 District",
            placeholder: "例如：士林 Shilin"
        },
        dueDate: {
            type: "select",
            title: "取(送)貨日期 Pickup/Delivery Date",
            isRequired: true
        },
        dueTime: {
            type: "select",
            title: "取(送)貨時間 Pickup/Delivery Time",
            isRequired: true
        },
        email: {
            type: "email",
            title: "電子郵件 Email",
            placeholder: "例如：info@yehcake.com",
            isRequired: true
        },
        file: {
            type: "file",
            title: "參閱照片 Reference Photo",
            tip: " If you have a specific design in mind, kindly upload a photo."
        },
        firstName: {
            type: "text",
            title: "名 First Name",
            placeholder: "例如：書豪 Jeremy",
            isRequired: true
        },
        flavor: {
            type: "select",
        ...
        guestOfHonorAge: {
            type: "number",
            title: "貴賓的年齡 Guest of Honor's Age",
            placeholder: "例如：5"
        },
        guestOfHonorGender: {
            type: "select",
            title: "貴賓的性別 Guest of Honor Gender"
        },
        guests: {
            type: "number",
            title: "賓客人數 Number of Guests",
            tip: " How many guests will you be serving?",
            placeholder: "例如：20"
        },
        inquire: {
            type: "button",
            title: "詢價 Inquire",
            placeholder: "詢價 Inquire"
        },
        inscription: {
            type: "text",
            title: "提字 Inscription",
            placeholder: "例如：Happy 5th Birthday!"
        },
        item: {
            type: "select",
            title: "品名 Item",
        ...
        occasion: {
            type: "text",
            title: "慶典 Occasion",
            tip: " What are you celebrating?",
            placeholder: "例如：生日 Birthday"
        },
        phone: {
            type: "number",
            title: "手機 Mobile Number",
            placeholder: "例如：0912345678",
            isRequired: true
        },
        postalCode: {
            type: "number",
            title: "郵遞區號 Postal Code",
            placeholder: "例如：111"
        },
        quantity: {
            type: "number",
        ...
        street: {
            type: "text",
            title: "路(街)名或村里名稱 Street",
            placeholder: "例如：天母西路 天母西路",
            isRequired: true
        },
        theme: {
            type: "text",
            title: "派對主題 Party Theme",
            tip: " Does the party have any particular theme?",
            placeholder: "例如：公主 Princess"
        },
        variant: {
            type: "select",
            title: "大小 Size",
            tip: " Which product variant would you like?"
        }
    };
    return result;
}
...
function getPostalCodes()
{
    ...
    results.push(getOptionAutoComplete(901, "901 屏東縣 三地門 (S��n dì mén, Pingtung County)", "901 屏東縣  三地門 Pingtung County Sān dì mén"));
