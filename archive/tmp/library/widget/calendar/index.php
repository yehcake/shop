...
<html>
    ...
    <head>
        <title>Events Calendar | Yeh! Cake</title>
        <meta charset="utf-8" />
    ...
    <body>
        <div class="pinterest-board">
            <div style="font-size: medium; margin-bottom: 10px; padding: 10px; text-align: center;"><a href="http://help.yehcake.com/attend/" target="_blank"><span lang="en-us">Continue</span> <span lang="zh-tw">前往</span></a></div>
        </div>
    </body>
</html>
