<?php
  ...
  $policy_json = '{"expiration":"2016-01-01T00:00:00.000Z","conditions":[["starts-with","$key",""],["content-length-range",0,10000000],{"acl":"bucket-owner-full-control"},{"bucket":"yc-dropbox"}]}';
