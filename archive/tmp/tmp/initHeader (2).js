$(document).ready(function(){
	...
	$( "#navbarCategoryButton" ).click(function() {   
		$(location).attr("href", "http://www.yehcake.com/shop/category/");
	});
	$( "#navbarPriceButton" ).click(function() {   
		$(location).attr("href", "http://www.yehcake.com/shop/price/");
	});
	$( "#navbarOccasionButton" ).click(function() {   
		$(location).attr("href", "http://www.yehcake.com/shop/occasion/");
	});	
	$( "#navbarSpecialsButton" ).click(function() {   
		$(location).attr("href", "http://www.yehcake.com/shop/specials/");
	});					
...
//			quote += data[k].author;
//		}		
	$( "#headerReview" ).text(getShortTestimonial(getRandomText(getTestimonials()), 60));
//	}, "jsonp"); 																										      		
}); 